...
| --- | --- | --- | --- | --- | --- |
| 弹拨尔 | 阿不力米提 | 《卡拉铁根》 | <audio controls preload="none" src="asset/samples/xfid/3-15.wav"></audio> | [<span class="midi-file-link"><span class="midi-file-icon"><i class="fa-regular fa-file midi-file-base"></i><i class="fa-solid fa-music midi-file-note"></i></span><span>kltg_auto.mid</span></span>](asset/samples/xfid/kltg_auto.mid) | [<span class="midi-file-link"><span class="midi-file-icon"><i class="fa-regular fa-file midi-file-base"></i><i class="fa-solid fa-music midi-file-note"></i></span><span>kltg_manual.mid</span></span>](asset/samples/xfid/kltg_manual.mid) |
